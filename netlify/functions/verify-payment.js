...
exports.handler = async function(event) {
  ...
  try {
    ...
    // session_id from ANY product (LeaseHelper, VerifyDoc, etc.) would otherwise
    // unlock FormGuard content here. Reject sessions whose payment_link isn't
    // in FormGuard's allowlist.
    //
