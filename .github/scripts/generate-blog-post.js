...
function renderHtml(parsed, slug, config, publishDate) {
  ...
  const css = [
    ...
    isDark
      ...
      : `:root{--brand:${config.primaryColor};--gold:${config.accentColor};--ink:#1a1a2e;--muted:#666;--rule:#e8e4de;--bg:${config.bgColor};--white:#fff;--accent:#f0ece4;--body-text:#333;--body-muted:#666}`,
    'body{font-family:"Source Sans 3",sans-serif;font-weight:400;color:var(--ink);background:var(--bg);line-height:1.75;font-size:17px;-webkit-font-smoothing:antialiased}',
    'a{color:var(--gold)}',
    ...
    '.tldr{background:var(--accent);border-left:4px solid var(--gold);border-radius:0 6px 6px 0;padding:18px 22px;margin:0 0 32px;font-size:1rem;line-height:1.7;color:var(--body-text)}',
    ...
    '.lede{font-size:1.08rem;line-height:1.78;color:var(--body-text);margin-bottom:32px}',
    '.lede p{margin-bottom:14px}',
    '.lede em{color:var(--body-muted);font-style:italic}',
    ...
    '.body p{margin-bottom:14px;color:var(--body-text);line-height:1.78}',
    '.body ul,.body ol{padding-left:0;margin-bottom:16px;list-style:none}',
    '.body li{padding:8px 0 8px 24px;position:relative;color:var(--body-text);line-height:1.7;border-bottom:1px solid var(--rule)}',
    ...
    '.faq-body{padding:2px 18px 16px;color:var(--body-muted);font-size:.92rem;line-height:1.72}',
